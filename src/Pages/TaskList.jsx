...
const handleSearch = (e) => {
  ...
  return (
    ...
    <Link to="/create-task" className='btn btn-info ms-auto create-task'><FontAwesomeIcon icon={faPenToSquare}/>Create Task</Link>
    </div>
